                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="card-content-blog">
                        <a href="{{ route('blog.detail', ['id' => $recent['id']]) }}">
                            <img src="{{ $recent->storageFile($recent['background']) }}" class="img-fluid img-fluid-module" alt="">
                            <div class="p-4 bg-white card-blog">
                                ...
                                <div class="fe-text-color">{{ App\Helpers\FormatHelpers::replaceQuill(App\Helpers\FormatHelpers::limiter($recent['description'], 150)) }}</div>
                            </div>
                        </a>
                    </div>
                </div>
